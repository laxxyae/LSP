    ...
    <nav class="navbar navbar-expand-lg bg-dark bg-light-radial navbar-dark py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <a href="/permohonan-kompetensi" class="nav-item nav-link {{ request()->is('permohonan-kompetensi') ? 'active' : '' }}">Uji Kompetensi</a> 
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Sertifikasi</a>
                    <div class="dropdown-menu m-0">
                        <a href="/skema-sertifikasi" class="dropdown-item {{ request()->is('skema-sertifikasi') ? 'active' : '' }}">Skema Sertifikasi</a>
                        <a href="/tempat-uji-kompetensi" class="dropdown-item {{ request()->is('tempat-uji-kompetensi') ? 'active' : '' }}">Tempat Uji Kompetensi</a>
                    </div>
                </div> 
